...
```bash
npx shadcn@latest add https://fartlabs.github.io/pixel-planet/r/pixel-planet.json
```

_This commands the CLI to fetch the component's code and dependencies directly from the repository's build output folder (\`/r\`)._
