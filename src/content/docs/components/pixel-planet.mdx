...
<CliCommandCode action="run" command={`shadcn@latest add ${SERVER_URL}`} />

_This commands the CLI to fetch the component's code and dependencies directly from our registry root endpoint._
