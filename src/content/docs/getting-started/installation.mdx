---
title: Installation
description: How to install Pixel Planet components in your project.
---

import CliCommandCode from "@/components/markdown/cli-command-code/cli-command-code.astro"
import { SERVER_URL } from "@/data/env"

It doesn't matter what framework or package manager you are using. Installing Pixel Planet components is as simple as running the `shadcn add pixel-planet/<component>` command and replacing `<component>` with the name of the component you want to install.
...
<CliCommandCode
  action="run"
  command="shadcn@latest add pixel-planet/action-button"
/>
